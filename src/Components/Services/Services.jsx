          ...
          <div
            ...
            >
                 <div className="flex flex-col items-center gap-4 top-1/4 md:right-32">
                    <h1 className="text-4xl font-bold tracking-tight text-gray-100 sm:text-6xl">Welcome to our Service Section <br/> </h1>

                    <span
                        className="mt-6 text-lg leading-8 text-gray-200"
                    >
                        This is our Service section where you can find all our severcises that we offer.
                    </span>

                            <a
                                href="#"
                                className="rounded-md bg-[#d3ad56] w-80 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[]-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                            >
                               Call Now
                            </a>
                </div>
